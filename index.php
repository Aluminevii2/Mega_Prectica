  ...
  <div class="page-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <main class="main-content">
        ...
        <section class="hero">
          ...
          <p data-i18n="heroDesc">Descoperă milioane de melodii, creează playlist-uri și împărtășește muzica cu
            prietenii.</p>
          <div class="hero-actions">
            <a href="#discover" class="btn btn-primary"><i class="ti ti-player-play"
                style="margin-right:.4rem"></i><span data-i18n="btnExplore">Explorează acum</span></a>
            <?php if (!$user): ?>
    ...
    <div class="player">
      <div class="player-track">
        ...
        <span class="song-like" data-song-id="player-liked" style="margin-left:.75rem"><i
